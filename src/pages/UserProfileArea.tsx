      ...
      <div className="w-full max-w-4xl mx-auto">
        <section className="mb-8">
          ...
          <p className="text-neutral-600">
            Gerencie seus dados pessoais e as configurações da sua empresa.
          </p>
        </section>
        ...
        {loading ? (
          ...
          <div className="bg-white border-2 border-neutral-200 rounded-2xl overflow-hidden shadow-sm">
            ...
            <form onSubmit={handleSave} className="p-8 space-y-8">
              {/* Personal Data */}
              <div>
                <h3 className="text-lg font-semibold text-neutral-900 mb-4 border-b border-neutral-100 pb-2">
                  Dados Pessoais
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:border-neutral-900 focus:outline-none transition-colors bg-white"
                    >
                      ...
                      <option value="Marketing E Agência">
                        Marketing E Agência
                      </option>
                    </select>
                  </div>
              ...
              <div className="pt-4 flex items-center justify-between border-t border-neutral-100">
                <div
                  ...
                  style={{ opacity: successMsg ? 1 : 0 }}
                >
                  <i className="fa-solid fa-check mr-2"></i>Alterações salvas
                  com sucesso!
                </div>
                <button
                  type="submit"
                  disabled={saving}
                  className="px-6 py-3 bg-neutral-900 text-white rounded-lg hover:bg-neutral-800 transition-colors font-medium flex items-center gap-2 disabled:opacity-70"
                >
                  {saving ? (
