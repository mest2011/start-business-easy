  ...
  return (
    <div className="border-2 border-neutral-200">
      ...
      >
        ...
        <i
          className={`fa-solid ${isOpen ? "fa-chevron-up" : "fa-chevron-down"} text-neutral-400`}
        ></i>
      </button>
      {isOpen && <div className="px-6 pb-6 text-neutral-600">{answer}</div>}
    </div>
  );
};
...
const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <header
        id="header"
        className="w-full border-b border-neutral-200 sticky top-0 bg-white z-50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl lg:text-2xl text-neutral-900 font-medium">
                EmpresaFácil
              </span>
            </div>
      ...
      <main id="onboarding-screen" className="w-full min-h-screen bg-white">
        ...
        <section
          id="hero-section"
          className="w-full flex items-center justify-center px-4 py-16 lg:py-20 border-b border-neutral-200"
        >
              ...
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <button
                    ...
                    className="px-8 py-4 border-2 border-neutral-300 text-neutral-700 rounded-lg hover:border-neutral-400 transition-colors"
                  >
                    Pular Configuração
                  </button>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
                Tudo o que você precisa para abrir e gerenciar sua empresa em um
                só lugar
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              <div className="border-2 border-neutral-200 p-8 hover:border-neutral-900 transition-all rounded-xl">
                ...
                <p className="text-neutral-600">
                  Processo 100% digital. Sua empresa pronta em até 48 horas
                  úteis.
                </p>
              </div>
              ...
              <div className="border-2 border-neutral-200 p-8 hover:border-neutral-900 transition-all rounded-xl">
                ...
                <p className="text-neutral-600">
                  Documentação validada por especialistas e criptografia de
                  ponta.
                </p>
              </div>
              ...
              <div className="border-2 border-neutral-200 p-8 hover:border-neutral-900 transition-all rounded-xl">
                ...
                <p className="text-neutral-600">
                  Dashboard intuitivo para acompanhar todas as métricas da sua
                  empresa.
                </p>
              </div>
        ...
        <section
          id="como-funciona"
          className="w-full py-20 lg:py-28 bg-neutral-50 border-y border-neutral-200"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl text-neutral-900 mb-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
              <div className="relative">
                <div className="bg-white border-2 border-neutral-200 p-8 rounded-xl z-10 relative">
                  ...
                  <p className="text-neutral-600">
                    Selecione entre MEI, ME, SLU ou LTDA conforme suas
                    necessidades.
                  </p>
                </div>
              ...
              <div className="relative">
                <div className="bg-white border-2 border-neutral-200 p-8 rounded-xl z-10 relative">
                  ...
                  <p className="text-neutral-600">
                    Informe os dados básicos da empresa e dos sócios de forma
                    simples.
                  </p>
                </div>
                <div className="hidden lg:block absolute top-1/2 -right-3 w-6 h-0.5 bg-neutral-300 transform -translate-y-1/2 z-0"></div>
              ...
              <div className="relative">
                <div className="bg-white border-2 border-neutral-200 p-8 rounded-xl z-10 relative">
                  ...
                  <p className="text-neutral-600">
                    Upload seguro de RG, CPF, comprovante de residência e outros
                    documentos.
                  </p>
                </div>
                <div className="hidden lg:block absolute top-1/2 -right-3 w-6 h-0.5 bg-neutral-300 transform -translate-y-1/2 z-0"></div>
              ...
              <div className="relative">
                <div className="bg-white border-2 border-neutral-200 p-8 rounded-xl z-10 relative">
                  ...
                  <p className="text-neutral-600">
                    Receba seu CNPJ e comece a empreender com toda a
        ...
        <section
          id="goal-selection"
          className="w-full bg-neutral-50 px-4 py-16 lg:py-20 border-y border-neutral-200"
        >
          <div className="w-full max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-6 hover:border-neutral-900 cursor-pointer transition-all group">
                ...
                <p className="text-neutral-600">
                  Aumente suas vendas com funil otimizado e estratégias de
                  marketing
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-6 hover:border-neutral-900 cursor-pointer transition-all group">
                ...
                <p className="text-neutral-600">
                  Controle receitas, despesas e planeje seu crescimento
                  financeiro
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-6 hover:border-neutral-900 cursor-pointer transition-all group">
                ...
                <p className="text-neutral-600">
                  Fortaleça sua marca nas redes sociais e canais digitais
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  "Processo super rápido e sem complicações. Em 2 dias minha
                  empresa estava pronta e pude começar a faturar imediatamente."
                </p>
                <div className="flex items-center gap-3">
                  <img
                    src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=42"
                    alt="Avatar"
                    className="w-12 h-12 bg-neutral-200 rounded-full"
                  />
                  <div>
                    <p className="text-neutral-900">Marina Silva</p>
                    <p className="text-sm text-neutral-500">
                      Designer Freelancer - MEI
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  "Excelente suporte! Tiraram todas minhas dúvidas sobre qual
                  tipo de empresa abrir. Recomendo muito a plataforma."
                </p>
                <div className="flex items-center gap-3">
                  <img
                    src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=87"
                    alt="Avatar"
                    className="w-12 h-12 bg-neutral-200 rounded-full"
                  />
                  <div>
              ...
              <div className="bg-white border-2 border-neutral-200 rounded-xl p-8">
                ...
                <p className="text-neutral-600 mb-6">
                  "A melhor decisão que tomei foi usar a EmpresaFácil. Dashboard
                  completo e fácil de usar para gerenciar tudo."
                </p>
                <div className="flex items-center gap-3">
                  <img
                    src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=153"
                    alt="Avatar"
                    className="w-12 h-12 bg-neutral-200 rounded-full"
                  />
                  <div>
            ...
            <div className="border-t-2 border-neutral-200 pt-12">
              <p className="text-center text-sm text-neutral-500 mb-8">
                Empresas que confiam na EmpresaFácil
              </p>
        ...
        <section
          id="faq"
          className="w-full py-20 lg:py-28 bg-neutral-50 border-t border-neutral-200"
        >
        ...
        <section
          id="profile-setup"
          className="w-full px-4 py-16 lg:py-20 bg-white"
        >
          <div className="w-full max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-neutral-600">
                Dê o primeiro passo rumo à formalização preenchendo os dados
                básicos do seu negócio
              </p>
            </div>
            ...
            <div className="bg-white border-2 border-neutral-200 rounded-2xl p-8 lg:p-10 shadow-sm">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <button
                    type="submit"
                    className="flex-1 px-8 py-4 bg-neutral-900 text-white rounded-lg text-lg hover:bg-neutral-800 transition-colors"
                  >
        ...
        <section
          id="cta-final"
          className="w-full py-20 lg:py-28 bg-neutral-900 text-white"
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl text-neutral-300 mb-10 max-w-2xl mx-auto">
              Junte-se a milhares de empreendedores que já abriram suas empresas
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
              <div>
                ...
                <p className="text-neutral-600 text-sm mb-4">
                  Simplificando a abertura e gestão de empresas para
                  empreendedores digitais em todo o Brasil.
                </p>
            ...
            <div className="pt-8 border-t border-neutral-200">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-neutral-500">
                  © 2026 EmpresaFácil. Todos os direitos reservados.
                </p>
