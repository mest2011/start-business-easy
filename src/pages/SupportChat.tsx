      ...
      <div className="w-full max-w-5xl mx-auto flex-1 flex flex-col bg-white border border-neutral-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 bg-neutral-900 border-b border-neutral-800 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative">
              <img
                src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=Afonso_Consultor"
                alt="Atendente"
                className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-white"
              />
              ...
              >
                {!isUser && (
                  <img
                    src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=Afonso_Consultor"
                    alt=""
                    className="w-8 h-8 rounded-full bg-white border border-neutral-200 mr-3 mt-auto mb-1 flex-shrink-0"
                  />
                )}
                <div
                  className={`max-w-[75%] lg:max-w-[60%] px-5 py-3 rounded-2xl shadow-sm relative group ${
                    isUser
                ...
                >
                  ...
                  <span
                    className={`text-[10px] mt-1.5 block select-none ${isUser ? "text-neutral-400 text-right" : "text-neutral-400"}`}
                  >
                    {msg.timestamp}{" "}
                    {isUser && (
                      <i className="fa-solid fa-check-double text-[10px] ml-1"></i>
                    )}
                  </span>
                </div>
              </div>
          ...
          {isTyping && (
            <div className="flex w-full justify-start">
              <img
                src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=Afonso_Consultor"
                alt=""
                className="w-8 h-8 rounded-full bg-white border border-neutral-200 mr-3 mb-1 mt-auto flex-shrink-0 opacity-70"
              />
        ...
        <div className="px-4 py-4 lg:px-6 lg:py-5 border-t border-neutral-200 bg-white">
          ...
          >
            <button
              type="button"
              className="text-neutral-400 hover:text-neutral-600 p-2 transition-colors hidden sm:block"
            >
          ...
          <div className="text-center mt-3 text-[10px] text-neutral-400 hidden sm:block">
            Nossos consultores usam seus dados estritamente para alavancagem dos
            seus dashboards. Não compartilhe senhas completas.
          </div>
        </div>
      </div>
    </div>
